                    ...
                    case 2:
                        ...
                        if(email!=null){
                            ...
                            while (choice2 != 5) {
                                ...
                                switch (choice2) {
                                    case 1:
                                        bank_manager.debit_money(account_number);
                                        break;
                                    case 2:
                                        bank_manager.credit_money(account_number);
                                        break;
                                    case 3:
                                        bank_manager.transfer_money(account_number);
                                        break;
                                    case 4:
                                        bank_manager.getBalance(account_number);
                                        break;
                                    case 5:
                                        break;
                                    default:
